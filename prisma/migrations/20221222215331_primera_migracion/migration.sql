...
-- AddForeignKey
ALTER TABLE `detalle_pedidos` ADD CONSTRAINT `detalle_pedidos_cabecera_id_fkey` FOREIGN KEY (`cabecera_id`) REFERENCES `cabecera_pedidos`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
